...
export default function MMHeader({
  ...
  const filteredMenuItems = useMemo(() => {
    ...
    // Add "Thư viện Cây" for users and guests
    items.push({
      id: "thu-vien-cay",
      label: "Thư viện Cây",
      href: "/plants",
  ...
  useEffect(() => {
    ...
    const fetchNotifications = async () => {
      try {
        ...
        // Fetch recent notifications (first page, 20 items)
        const notificationsResponse =
          await NotificationRepository.getUserNotifications(1, 20, null, null);
  ...
  // openMenu / closeMenu removed (no slide-out drawer anymore)
  ...
  return (
    <>
      ...
      >
        <div className="relative w-full px-3 sm:px-4 md:px-6 h-[80px] flex items-center gap-2 sm:gap-3 md:gap-5">
          {/* Logo */}
          <a
            href="#"
          ...
          <div className="hidden md:flex absolute left-1/2 top-0 h-full transform -translate-x-1/2 items-center">
