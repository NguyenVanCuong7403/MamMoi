...
export default function EditTreeBasic() {
  ...
  return (
    <div data-fluid-page className="min-h-screen bg-neutral-50">
      <header className="bg-emerald-900 text-white">
        <div data-fluid-shell className="mx-auto max-w-7xl px-6 py-5 flex items-center justify-between">
      ...
      {banner && (
        <div data-fluid-shell className="mx-auto max-w-7xl px-6 pt-3">
      ...
      <main
        data-fluid-shell
        className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 grid lg:grid-cols-3 gap-6 relative isolate"
      >
        {/* LEFT */}
