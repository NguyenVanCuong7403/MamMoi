        ...
        <div className="min-h-screen bg-[#FBFFDF] text-[#1F302F] font-sans selection:bg-[#FFFFA5] selection:text-[#1F302F]">
            ...
            <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 px-4 md:px-[90px] overflow-hidden bg-[#1F302F] text-[#FBFFDF]">
                ...
                <div className="max-w-6xl mx-auto text-center relative z-10">
                    ...
                    >
                        Giải pháp nông nghiệp thông minh <br className="hidden md:block" /> cho người làm vườn thời đại mới
                    </motion.h1>
                    <motion.p
                        initial="hidden"
                        whileInView="visible"
                    ...
                    >
                        Mầm Mới không chỉ là một ứng dụng, mà là người bạn đồng hành tin cậy, giúp bạn quản lý vườn cây ăn quả từ khâu xuống giống đến khi thu hoạch một cách khoa học và hiệu quả nhất.
                    </motion.p>
                    <motion.div
                        initial="hidden"
                        whileInView="visible"
            ...
            <section className="py-20 bg-[#fff]/60">
                <div className="max-w-7xl mx-auto px-4 md:px-[90px]">
                    <div className="text-center mb-16">
                        <h2 className="text-[clamp(32px,3.5vw,48px)] font-bold mb-4">Chức năng cốt lõi</h2>
                        <p className="text-lg text-[#243833]/70 max-w-2xl mx-auto">
                            Hệ thống tính năng toàn diện giúp số hóa quy trình quản lý vườn của bạn.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Số hóa từng gốc cây với mã định danh riêng biệt. Theo dõi chi tiết lịch sử sinh trưởng, bệnh hại và năng suất."
                            },
                            {
                                icon: <BarChart3 className="w-8 h-8" />,
                                title: "Lập kế hoạch chăm sóc",
                                desc: "Tự động đề xuất lịch bón phân, tưới nước, tỉa cành dựa trên giai đoạn phát triển và dữ liệu thực tế."
                            },
                            {
                                icon: <ShieldCheck className="w-8 h-8" />,
                                title: "Giám sát sâu bệnh",
                                desc: "Hệ thống cảnh báo sớm dịch bệnh và đề xuất phương án xử lý kịp thời, giảm thiểu rủi ro mất mùa."
                            }
                        ].map((item, idx) => (
                            <motion.div
                                key={idx}
            ...
            <section className="py-20 bg-[#1F302F] text-[#FBFFDF]">
                <div className="max-w-7xl mx-auto px-4 md:px-[90px]">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        <div>
                            <h2 className="text-[clamp(32px,3.5vw,48px)] font-bold mb-6">Lợi ích mang lại</h2>
                            <div className="space-y-8">
                                {[
                                    ...
                                    <div key={idx} className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="text-xl font-bold text-[#FFFFA5] mb-2">{item.title}</h4>
            ...
            <section className="py-24 bg-[#E6E7E0]">
                <div className="max-w-7xl mx-auto px-4 md:px-[90px]">
                    <div className="text-center mb-16">
                        <h2 className="text-[clamp(32px,3.5vw,48px)] font-bold mb-4 text-[#1F302F]">Tiện ích mở rộng</h2>
                    </div>
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { icon: <CloudSun />, title: "Dự báo thời tiết", desc: "Cảnh báo mưa, bão, nắng hạn chi tiết cho từng vùng trồng." },
                            { icon: <ScanLine />, title: "Truy xuất nguồn gốc", desc: "Tạo mã QR cho nông sản, minh bạch thông tin với người dùng." },
                            { icon: <Users />, title: "Cộng đồng", desc: "Kết nối, chia sẻ kinh nghiệm với mạng lưới chuyên gia và nhà nông." },
                            { icon: <Smartphone />, title: "Mobile App", desc: "Trải nghiệm mượt mà trên cả iOS và Android." },
                        ].map((u, i) => (
                            <div key={i} className="bg-[#FBFFDF] p-6 rounded-xl shadow-sm hover:shadow-md transition text-center">
                                <div className="w-12 h-12 mx-auto bg-[#E6E7E0] rounded-full flex items-center justify-center text-[#1F302F] mb-4">
                                    {u.icon}
                                </div>
                                <h4 className="font-bold text-lg mb-2 text-[#1F302F]">{u.title}</h4>
                ...
                <div className="max-w-5xl mx-auto bg-[#243833] rounded-[30px] p-8 md:p-16 text-center text-[#FBFFDF] relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-lg md:text-xl text-[#FBFFDF]/80 mb-10 max-w-2xl mx-auto">
                            Tham gia cùng hàng ngàn nhà nông đang ứng dụng công nghệ để làm giàu từ chính mảnh đất của mình.
                        </p>
