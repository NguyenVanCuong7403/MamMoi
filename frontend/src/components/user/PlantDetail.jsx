      ...
      <section className="relative h-[30vh] min-h-[240px] w-full overflow-hidden bg-gradient-to-br from-emerald-900/80 via-emerald-800/70 to-emerald-900/80 sm:h-[35vh] sm:min-h-[280px] lg:h-[40vh] lg:min-h-[320px]">
        ...
        <div className="absolute bottom-0 left-0 right-0 z-20 px-0 pb-6 sm:pb-8 md:pb-10 lg:pb-12">
          ...
          >
            ...
            >
              {plantData.treeTypeName?.startsWith("Cây ") ? plantData.treeTypeName : `Cây ${plantData.treeTypeName || ""}`}
            </h1>
                  ...
                  <Card className="bg-white/95 backdrop-blur-sm border-white/20">
                    ...
                    <CardContent>
                      <div
                        ...
                        style={{
                          maxHeight: plantData.careGuide.length > CARE_GUIDE_LIMIT
                      ...
                      {plantData.careGuide.length > CARE_GUIDE_LIMIT && (
                        <p className="mt-3 text-xs text-slate-500 text-center">
                          Cuộn xuống để xem thêm {plantData.careGuide.length - CARE_GUIDE_LIMIT} hướng dẫn
                        </p>
                      )}
                    </CardContent>
                  </Card>
                    ...
                    >
                      <Card className="bg-white/95 backdrop-blur-sm border-white/20">
                        ...
                        <CardContent>
                          ...
                          {hasMoreVarieties && (
                            <p className="mt-3 text-xs text-slate-500 text-center">
                              Cuộn xuống để xem thêm {totalVarieties - VARIETY_LIMIT} giống
                            </p>
                          )}
                        </CardContent>
                      </Card>
                  ...
                  >
                    <Card className="bg-white/95 backdrop-blur-sm border-white/20">
                      ...
                      <CardContent>
                        ...
                        {hasMorePests && (
                          <p className="mt-3 text-xs text-slate-500 text-center">
                            Cuộn xuống để xem thêm {totalPests - PEST_LIMIT} bệnh
                          </p>
                        )}
                      </CardContent>
                    </Card>
