  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const demoTrees = [
          {
            ...
            isActive: true,
            description:
              "Cây xoài là loại cây ăn quả nhiệt đới phổ biến, cho quả ngọt và thơm.",
            imageUrl:
              "https://images.unsplash.com/photo-1605027990121-cbae48b8c473?w=400",
          ...
          },
          {
            ...
            isActive: true,
            description:
              "Cây chuối phát triển nhanh, cho quả giàu kali và chất dinh dưỡng.",
            imageUrl:
              "https://images.unsplash.com/photo-1605027990121-cbae48b8c473?w=400",
          ...
          },
          {
            ...
            isActive: true,
            description:
              "Cây cam cho quả mọng nước, giàu vitamin C, thích hợp khí hậu nhiệt đới.",
            imageUrl:
              "https://images.unsplash.com/photo-1605027990121-cbae48b8c473?w=400",
          ...
          },
          {
            ...
            isActive: true,
            description:
              "Cây bưởi cho quả to, mọng nước, có nhiều giống khác nhau.",
            imageUrl:
              "https://images.unsplash.com/photo-1605027990121-cbae48b8c473?w=400",
            optimalTemperatureMin: 18,
            optimalTemperatureMax: 32,
          ...
          },
          {
            ...
            isActive: true,
            description:
              "Cây nhãn cho quả ngọt, thơm, thích hợp khí hậu nhiệt đới và cận nhiệt đới.",
            imageUrl:
              "https://images.unsplash.com/photo-1605027990121-cbae48b8c473?w=400",
            optimalTemperatureMin: 20,
            optimalTemperatureMax: 35,
          ...
          },
          {
            ...
            isActive: true,
            description:
              "Cây mít cho quả to, thơm, nhiều múi, thích hợp khí hậu nhiệt đới.",
            imageUrl:
              "https://images.unsplash.com/photo-1605027990121-cbae48b8c473?w=400",
            optimalTemperatureMin: 22,
            optimalTemperatureMax: 35,
          ...
          },
          {
            ...
            isActive: true,
            description:
              "Cây sầu riêng cho quả đặc trưng, thơm nồng, được mệnh danh là vua của các loại trái cây.",
            imageUrl:
              "https://images.unsplash.com/photo-1605027990121-cbae48b8c473?w=400",
          ...
          },
          {
            ...
            isActive: true,
            description:
              "Cây măng cụt cho quả có vỏ tím, thịt trắng ngọt thanh, được mệnh danh là nữ hoàng trái cây.",
            imageUrl:
              "https://images.unsplash.com/photo-1605027990121-cbae48b8c473?w=400",
            optimalTemperatureMin: 20,
            optimalTemperatureMax: 32,
          ...
          },
          {
            ...
            isActive: true,
            description:
              "Cây dừa cho quả nhiều nước, thơm mát, thích hợp vùng ven biển.",
            imageUrl:
              "https://images.unsplash.com/photo-1605027990121-cbae48b8c473?w=400",
          ...
          },
          {
            ...
            isActive: true,
            description:
              "Cây thanh long cho quả có vỏ đỏ hoặc vàng, thịt trắng hoặc đỏ, ngọt mát.",
            imageUrl:
              "https://images.unsplash.com/photo-1605027990121-cbae48b8c473?w=400",
            optimalTemperatureMin: 20,
            optimalTemperatureMax: 35,
        ...
        const allTrees = [...treesWithDetails, ...demoTrees];
        setTrees(allTrees);
      } catch (error) {
