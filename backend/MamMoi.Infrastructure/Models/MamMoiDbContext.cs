...
public partial class MamMoiDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.LogId).HasName("PK__Activity__5E5499A8CFD60E69");
        ...
        {
            entity.HasKey(e => e.ConsultationId).HasName("PK__AIConsul__5D014A788D1352FE");
        ...
        {
            entity.HasKey(e => e.RecommendationId).HasName("PK__AIRecomm__AA15BEC441B38E8A");
        ...
        {
            entity.HasKey(e => e.ScheduleId).HasName("PK__CareSche__9C8A5B69B3272B0D");
        ...
        {
            entity.HasKey(e => e.DiseaseId).HasName("PK__DiseaseL__69B533A9E3BCF672");

            entity.ToTable("DiseaseLibrary");

            entity.HasIndex(e => e.DiseaseName, "UQ__DiseaseL__5112584D09284C66").IsUnique();
        ...
        {
            entity.HasKey(e => e.GardenId).HasName("PK__Gardens__0191D06386FB7AA8");
        ...
        {
            entity.HasKey(e => e.MemberId).HasName("PK__GardenMe__0CF04B3844629C2D");
        ...
        {
            entity.HasKey(e => e.GardenSoilId).HasName("PK__GardenSo__0F59789A8569BCD1");
        ...
        {
            entity.HasKey(e => e.NotificationId).HasName("PK__Notifica__20CF2E32CB0DCF9D");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payments__9B556A58837CE392");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Roles__8AFACE3AD13C9098");
        ...
        {
            entity.HasKey(e => e.SoilMasterId).HasName("PK__SoilMast__718F92EF524DBE81");
        ...
        {
            entity.HasKey(e => e.SubscriptionId).HasName("PK__Subscrip__9A2B24BDC573FE2C");
        ...
        {
            entity.HasKey(e => e.PlanId).HasName("PK__Subscrip__755C22D7CB5622A2");

            entity.HasIndex(e => e.PlanName, "UQ__Subscrip__46E12F9EEC9C2234").IsUnique();
        ...
        {
            entity.HasKey(e => e.RequestId).HasName("PK__SupportR__33A8519A87C80BE2");
        ...
        {
            entity.HasKey(e => e.SettingId).HasName("PK__SystemSe__54372AFD6BB4AA05");

            entity.HasIndex(e => e.SettingKey, "UQ__SystemSe__01E719AD26463990").IsUnique();
        ...
        {
            entity.HasKey(e => e.TreeId).HasName("PK__Trees__35F324C5506012D2");
            ...
            entity.HasMany(d => d.Diseases).WithMany(p => p.Trees)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("TreeId", "DiseaseId").HasName("PK__Trees_Di__B36877FF59733C18");
        ...
        {
            entity.HasKey(e => e.StageId).HasName("PK__TreeGrow__03EB7AF8D7CD8ABC");
        ...
        {
            entity.HasKey(e => e.ImageId).HasName("PK__TreeImag__7516F4EC81190E8F");
            ...
            entity.Property(e => e.AianalysisStatus)
                .HasMaxLength(50)
                .HasColumnName("AIAnalysisStatus");
        ...
        {
            entity.HasKey(e => e.TreeTypeId).HasName("PK__TreeType__7AD87BF48F7AA635");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCACDCDFA4A6");

            entity.HasIndex(e => e.Email, "IX_Users_Email");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D1053475644838").IsUnique();
        ...
        {
            entity.HasKey(e => e.AlertId).HasName("PK__WeatherA__EBB16AED4B881BAE");
            ...
            entity.Property(e => e.RelatedWeatherIds)
                .HasMaxLength(500)
                .HasColumnName("RelatedWeatherIDs");
            entity.Property(e => e.Severity).HasMaxLength(20);
            entity.Property(e => e.Status)
                .HasMaxLength(50)
                .HasDefaultValue("Active");
            ...
            entity.Property(e => e.WeatherApisource)
                .HasMaxLength(100)
                .HasColumnName("WeatherAPISource");
        ...
        {
            entity.HasKey(e => e.WeatherId).HasName("PK__WeatherH__0BF97BD52A7D2E08");

            entity.HasIndex(e => e.TreeId, "IX_Weather_TreeID");

            entity.Property(e => e.WeatherId).HasColumnName("WeatherID");
            entity.Property(e => e.ApirespondedAt)
                .HasPrecision(0)
                .HasColumnName("APIRespondedAt");
